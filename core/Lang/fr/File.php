...
return [
	...
	'fileNotExist' => 'Fichier n\'existe pas "{0}" ',
	'dirNotExist' => 'Répertoire innéxistant : "{0}" ',
	...
	'unreadable'   => 'Fichier {0} illisible - vérifiez que votre fichier existe et est accessible',
];
