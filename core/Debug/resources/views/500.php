...
use function Footup\Debug\Support\{
    str_last,
    ouch_assets,
    readErrorFile,
    readErrorLine
                        ...
                        <div class="hero hero-sm show-hero" id="hero-exp-0">
                            <div class="hero-body">
                                ...
                                <div class="help-links">
                                    <a href='https://stackoverflow.com/search?q=PHP <?=urlencode($ex->message)?>' target="_blank" title="open in stackoverflow">
                                    ...
                                    <a href='https://www.reddit.com/search?q=PHP <?=urlencode($ex->message)?>' target="_blank" title="open in reddit">
                                    ...
                                    <a href='https://www.google.dz/search?q=PHP <?=urlencode($ex->message)?>' target="_blank" title="open in google">
